...
public class Frame extends FrameLayout {
    ...
    public WoovlyFrame(Context context) {
        super(context);
    }

    public WoovlyFrame(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public WoovlyFrame(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = WoovlyFrame.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = WoovlyFrame.this.getViewTreeObserver();
                    }
